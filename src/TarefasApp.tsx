...
const TarefasApp: React.FC = () => {
  ...
  // ✅ Começa como null para mostrar TODAS as tarefas ao abrir
  const [dataSelecionada, setDataSelecionada] = useState<Date | null>(null);
  const [busca, setBusca] = useState('');

  const excluir = (id: number, e: React.MouseEvent) => {
    e.stopPropagation(); // Impede que abra a edição ao clicar em excluir
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-3">
            <input className="form-control mb-3" placeholder="Procurar..." onChange={e => setBusca(e.target.value)} />
            
            {/* ✅ Calendário agora recebe a função de clique */}
            <Calendario 
              tarefas={tarefas} 
          ...
          <div className="col-md-9">
            <div className="d-flex justify-content-between mb-4">
              ...
              <Link to="/nova-tarefa" className="btn btn-primary">+ Nova</Link>
            </div>
            ...
            {tarefasFiltradas.map(tarefa => (
              <div 
                ...
                onClick={() => navigate(`/editar-tarefa/${tarefa.id}`)} // ✅ Clique na lista
              ...
              >
                <div className="card-body d-flex justify-content-between align-items-center">
                  ...
                  <button className="btn btn-outline-danger btn-sm" onClick={(e) => excluir(tarefa.id, e)}>
